...
public static class Tablet
{
    ...
    /// <summary>
    /// What the desktop said about a command, in words a person can act on (#290), served separately for
    /// the same reason as <see cref="RelayCryptoScript"/>: it is plain JavaScript Node can test
