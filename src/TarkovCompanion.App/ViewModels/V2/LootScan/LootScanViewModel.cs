...
public sealed class LootScanDecisionViewModel : BindableViewModel
{
    ...
    public string VerdictLabel => IsPending
        ...
        : IsAdvisedTake ? _text.VerdictAdvisedTake : _text.Verdict(_decision.Verdict);
...
{
    public string Heading { get; init; } = IntelText.LootScanHeading;
    public string StatusStale { get; init; } = IntelText.LootScanStatusStale;
    public string StatusUnknown { get; init; } = IntelText.LootScanStatusUnknown;
    public string StatusComplete { get; init; } = IntelText.LootScanStatusComplete;
    public string StatusPartial { get; init; } = IntelText.LootScanStatusPartial;
    public string StatusUnavailable { get; init; } = IntelText.LootScanStatusUnavailable;
    public string StatusRecognising { get; init; } = IntelText.LootScanStatusRecognising;
    public string StatusStopped { get; init; } = IntelText.LootScanStatusStopped;
    public string StatusDetailStale { get; init; } = IntelText.LootScanStatusDetailStale;
    public string StatusDetailUnknown { get; init; } = IntelText.LootScanStatusDetailUnknown;
    public string StatusDetailComplete { get; init; } = IntelText.LootScanStatusDetailComplete;
    public string StatusDetailPartial { get; init; } = IntelText.LootScanStatusDetailPartial;
    public string StatusDetailUnavailable { get; init; } = IntelText.LootScanStatusDetailUnavailable;
    public string StatusDetailRecognising { get; init; } = IntelText.LootScanStatusDetailRecognising;
    public string StatusDetailStopped { get; init; } = IntelText.LootScanStatusDetailStopped;
    public string CurrentCaptureContext { get; init; } = IntelText.LootScanCurrentCaptureContext;
    public string CaptureTemplate { get; init; } = IntelText.LootScanCaptureTemplate;
    public string MillisecondsTemplate { get; init; } = IntelText.LootScanMillisecondsTemplate;
    public string SecondsTemplate { get; init; } = IntelText.LootScanSecondsTemplate;
    public string FocusTemplate { get; init; } = IntelText.LootScanFocusTemplate;
    public string TakeCountTemplate { get; init; } = IntelText.LootScanTakeCountTemplate;
    public string SwapCountTemplate { get; init; } = IntelText.LootScanSwapCountTemplate;
    public string LeaveCountTemplate { get; init; } = IntelText.LootScanLeaveCountTemplate;
    public string ReviewCountTemplate { get; init; } = IntelText.LootScanReviewCountTemplate;
    public string HiddenIssuesTemplate { get; init; } = IntelText.LootScanHiddenIssuesTemplate;
    public string PageTemplate { get; init; } = IntelText.LootScanPageTemplate;
    public string AutomationSummaryTemplate { get; init; } = IntelText.LootScanAutomationSummaryTemplate;
    public string SizeTemplate { get; init; } = IntelText.LootScanSizeTemplate;
    public string FootprintNeedsReview { get; init; } = IntelText.LootScanFootprintNeedsReview;
    public string IdentityUnresolved { get; init; } = IntelText.LootScanIdentityUnresolved;
    public string StackTemplate { get; init; } = IntelText.LootScanStackTemplate;
    public string FoundInRaid { get; init; } = IntelText.LootScanFoundInRaid;
    public string NotFoundInRaid { get; init; } = IntelText.LootScanNotFoundInRaid;
    public string ConditionValuesTemplate { get; init; } = IntelText.LootScanConditionValuesTemplate;
    public string ConditionKindTemplate { get; init; } = IntelText.LootScanConditionKindTemplate;
    public string NoAttributeDetail { get; init; } = IntelText.LootScanNoAttributeDetail;
    public string NetValueTemplate { get; init; } = IntelText.LootScanNetValueTemplate;
    public string ValueNeedsReview { get; init; } = IntelText.LootScanValueNeedsReview;
    public string ValuePerSquareTemplate { get; init; } = IntelText.LootScanValuePerSquareTemplate;
    public string ValuePerSquareUnavailable { get; init; } = IntelText.LootScanValuePerSquareUnavailable;
    public string UnknownValueBand { get; init; } = IntelText.LootScanUnknownValueBand;
    public string FleaNetBasis { get; init; } = IntelText.LootScanFleaNetBasis;
    public string TraderBasis { get; init; } = IntelText.LootScanTraderBasis;
    public string PriceSourceNeedsReview { get; init; } = IntelText.LootScanPriceSourceNeedsReview;
    public string PlacementTemplate { get; init; } = IntelText.LootScanPlacementTemplate;
    public string PlacementRotatedTemplate { get; init; } = IntelText.LootScanPlacementRotatedTemplate;
    public string SwapSummaryTemplate { get; init; } = IntelText.LootScanSwapSummaryTemplate;
    public string DropTemplate { get; init; } = IntelText.LootScanDropTemplate;
    public string RecommendationReasonTemplate { get; init; } = IntelText.LootScanRecommendationReasonTemplate;
    public string OpportunityCostTemplate { get; init; } = IntelText.LootScanOpportunityCostTemplate;
    public string OpportunityCostLineageTemplate { get; init; } = IntelText.LootScanOpportunityCostLineageTemplate;
    public string OpportunityCostUnavailable { get; init; } = IntelText.LootScanOpportunityCostUnavailable;
    public string EconomicEvidenceWithInputsTemplate { get; init; } = IntelText.LootScanEconomicEvidenceWithInputsTemplate;
    public string EconomicInputsEvidenceTemplate { get; init; } = IntelText.LootScanEconomicInputsEvidenceTemplate;
    public string UnknownEconomicStatus { get; init; } = IntelText.LootScanUnknownEconomicStatus;
    public string EconomicEvidenceUnavailable { get; init; } = IntelText.LootScanEconomicEvidenceUnavailable;
    public string EvidenceDisclosureTemplate { get; init; } = IntelText.LootScanEvidenceDisclosureTemplate;
    public string IdentityMatched { get; init; } = IntelText.LootScanIdentityMatched;
    public string OneAlternateIdentity { get; init; } = IntelText.LootScanOneAlternateIdentity;
    public string AlternateIdentitiesTemplate { get; init; } = IntelText.LootScanAlternateIdentitiesTemplate;
    public string EvidenceUnavailable { get; init; } = IntelText.LootScanEvidenceUnavailable;
    public string ReviewOrCorrect { get; init; } = IntelText.LootScanReviewOrCorrect;
    public string OpenEvidence { get; init; } = IntelText.LootScanOpenEvidence;
    public string ProvenanceTemplate { get; init; } = IntelText.LootScanProvenanceTemplate;
    public string TimestampAhead { get; init; } = IntelText.LootScanTimestampAhead;
    public string Unscored { get; init; } = IntelText.LootScanUnscored;
    public string JustNow { get; init; } = IntelText.LootScanJustNow;
    public string MinutesOldTemplate { get; init; } = IntelText.LootScanMinutesOldTemplate;
    public string HoursOldTemplate { get; init; } = IntelText.LootScanHoursOldTemplate;
    public string DaysOldTemplate { get; init; } = IntelText.LootScanDaysOldTemplate;
    public string ItemAtTemplate { get; init; } = IntelText.LootScanItemAtTemplate;
    public string FilterAll { get; init; } = IntelText.LootScanFilterAll;
    public string FilterTake { get; init; } = IntelText.LootScanFilterTake;
    public string FilterSwap { get; init; } = IntelText.LootScanFilterSwap;
    public string FilterLeave { get; init; } = IntelText.LootScanFilterLeave;
    public string FilterReview { get; init; } = IntelText.LootScanFilterReview;
    public string NothingToDecide { get; init; } = IntelText.LootScanNothingToDecide;
    public string PendingCountTemplate { get; init; } = IntelText.LootScanPendingCountTemplate;
    public string OneItemTemplate { get; init; } = IntelText.LootScanOneItemTemplate;
    public string ItemsTemplate { get; init; } = IntelText.LootScanItemsTemplate;
    public string AnalysedInTemplate { get; init; } = IntelText.LootScanAnalysedInTemplate;
    public string ProgressTiming { get; init; } = IntelText.LootScanProgressTiming;
    public string ShortPerSquareTemplate { get; init; } = IntelText.LootScanShortPerSquareTemplate;
    public string GivesUpTemplate { get; init; } = IntelText.LootScanGivesUpTemplate;
    public string DropSummaryTemplate { get; init; } = IntelText.LootScanDropSummaryTemplate;
    public string GridSizeTemplate { get; init; } = IntelText.LootScanGridSizeTemplate;
    public string FreeSquaresTemplate { get; init; } = IntelText.LootScanFreeSquaresTemplate;
    public string OneFreeSquare { get; init; } = IntelText.LootScanOneFreeSquare;
    public string UnknownItem { get; init; } = IntelText.LootScanUnknownItem;
    public string CarriedSpace { get; init; } = IntelText.LootScanCarriedSpace;
    public string Backpack { get; init; } = IntelText.LootScanBackpack;
    public string TacticalRig { get; init; } = IntelText.LootScanTacticalRig;
    public string Pockets { get; init; } = IntelText.LootScanPockets;
    public string CarriedGridIndexTemplate { get; init; } = IntelText.LootScanCarriedGridIndexTemplate;
    public string CarriedGridFullTemplate { get; init; } = IntelText.LootScanCarriedGridFullTemplate;
    public string CarriedGridFreeTemplate { get; init; } = IntelText.LootScanCarriedGridFreeTemplate;
    public string ReasonExplicit { get; init; } = IntelText.LootScanReasonExplicit;
    public string ReasonProtected { get; init; } = IntelText.LootScanReasonProtected;
    public string ReasonCurrentQuestFir { get; init; } = IntelText.LootScanReasonCurrentQuestFir;
    public string ReasonCurrentQuest { get; init; } = IntelText.LootScanReasonCurrentQuest;
    public string ReasonFutureQuest { get; init; } = IntelText.LootScanReasonFutureQuest;
    public string ReasonHideout { get; init; } = IntelText.LootScanReasonHideout;
    public string ReasonCraft { get; init; } = IntelText.LootScanReasonCraft;
    public string ReasonUtility { get; init; } = IntelText.LootScanReasonUtility;
    public string ReasonPinned { get; init; } = IntelText.LootScanReasonPinned;
    public string ReasonScarce { get; init; } = IntelText.LootScanReasonScarce;
    public string ReasonValueOnly { get; init; } = IntelText.LootScanReasonValueOnly;
    public string ReasonNeedTemplate { get; init; } = IntelText.LootScanReasonNeedTemplate;
    public string ReasonEventAllergic { get; init; } = IntelText.LootScanReasonEventAllergic;
    public string ReasonEventUntested { get; init; } = IntelText.LootScanReasonEventUntested;
    public string RefusedNoMatch { get; init; } = IntelText.LootScanRefusedNoMatch;
    public string RefusedOneLookalikeTemplate { get; init; } = IntelText.LootScanRefusedOneLookalikeTemplate;
    public string RefusedTwoLookalikesTemplate { get; init; } = IntelText.LootScanRefusedTwoLookalikesTemplate;
    public string RefusedManyLookalikesTemplate { get; init; } = IntelText.LootScanRefusedManyLookalikesTemplate;
    public string RefusedAttributesUnread { get; init; } = IntelText.LootScanRefusedAttributesUnread;
    public string RefusedNoPrice { get; init; } = IntelText.LootScanRefusedNoPrice;
    public string RefusedValuedOnly { get; init; } = IntelText.LootScanRefusedValuedOnly;
    public string WhyNoMatch { get; init; } = IntelText.LootScanWhyNoMatch;
    public string WhyLookalikes { get; init; } = IntelText.LootScanWhyLookalikes;
    public string WhyAttributesUnread { get; init; } = IntelText.LootScanWhyAttributesUnread;
    public string WhyNoPrice { get; init; } = IntelText.LootScanWhyNoPrice;
    public string WhyValuedOnly { get; init; } = IntelText.LootScanWhyValuedOnly;
    public string WhyWorthItsSquares { get; init; } = IntelText.LootScanWhyWorthItsSquares;
    public string ReasonWorthItsSquares { get; init; } = IntelText.LootScanReasonWorthItsSquares;
    public string VerdictAdvisedTake { get; init; } = IntelText.LootScanVerdictAdvisedTake;
    public string VerdictPending { get; init; } = IntelText.LootScanVerdictPending;
    public string PendingReason { get; init; } = IntelText.LootScanPendingReason;
    public string Pin { get; init; } = IntelText.LootScanPin;
    public string Unpin { get; init; } = IntelText.LootScanUnpin;
    public string Wish { get; init; } = IntelText.LootScanWish;
    public string Unwish { get; init; } = IntelText.LootScanUnwish;
    public string AlwaysTake { get; init; } = IntelText.LootScanAlwaysTake;
    public string AlwaysLeave { get; init; } = IntelText.LootScanAlwaysLeave;
    public string PhaseLabel { get; init; } = IntelText.LootScanPhaseLabel;
    public string RiskLabel { get; init; } = IntelText.LootScanRiskLabel;
    public string PhaseCounted { get; init; } = IntelText.LootScanPhaseCounted;
    public string PhaseEarly { get; init; } = IntelText.LootScanPhaseEarly;
    public string PhaseMiddle { get; init; } = IntelText.LootScanPhaseMiddle;
    public string PhaseLate { get; init; } = IntelText.LootScanPhaseLate;
    public string PhaseExtracting { get; init; } = IntelText.LootScanPhaseExtracting;
    public string RiskLow { get; init; } = IntelText.LootScanRiskLow;
    public string RiskElevated { get; init; } = IntelText.LootScanRiskElevated;
    public string RiskHigh { get; init; } = IntelText.LootScanRiskHigh;
    public string RiskCritical { get; init; } = IntelText.LootScanRiskCritical;
    public string GapOneTemplate { get; init; } = IntelText.LootScanGapOneTemplate;
    public string GapManyTemplate { get; init; } = IntelText.LootScanGapManyTemplate;
    public string GapRaidPhase { get; init; } = IntelText.LootScanGapRaidPhase;
    public string GapRaidRisk { get; init; } = IntelText.LootScanGapRaidRisk;
    public string GapFleaNet { get; init; } = IntelText.LootScanGapFleaNet;
    public string GapPrice { get; init; } = IntelText.LootScanGapPrice;
    public string GapScarcity { get; init; } = IntelText.LootScanGapScarcity;
    public string GapProfile { get; init; } = IntelText.LootScanGapProfile;
    public string GapItemRule { get; init; } = IntelText.LootScanGapItemRule;
    public string GapHoldings { get; init; } = IntelText.LootScanGapHoldings;
    public string GapFoundInRaid { get; init; } = IntelText.LootScanGapFoundInRaid;
    public string GapBackpack { get; init; } = IntelText.LootScanGapBackpack;
    public string FleaAverageBasis { get; init; } = IntelText.LootScanFleaAverageBasis;
    public string CatalogValuePerSquareTemplate { get; init; } = IntelText.LootScanCatalogValuePerSquareTemplate;
    public string ReasonFits { get; init; } = IntelText.LootScanReasonFits;
    public string ReasonSwapFits { get; init; } = IntelText.LootScanReasonSwapFits;
    public string ReasonNoRoom { get; init; } = IntelText.LootScanReasonNoRoom;
    public string ReasonSwapCosts { get; init; } = IntelText.LootScanReasonSwapCosts;

    /// <summary>#572: the small countdown that says the page is about to return to the map.</summary>
    public string ReturnCountdownTemplate { get; init; } = IntelText.LootScanReturnCountdownTemplate;
    public string ReturnCountdownLessThanOne { get; init; } = IntelText.LootScanReturnCountdownLessThanOne;
    public string StayLabel { get; init; } = IntelText.LootScanStayLabel;
    public string StayingLabel { get; init; } = IntelText.LootScanStayingLabel;

    public string VerdictTake { get; init; } = IntelText.LootScanVerdictTake;
    public string VerdictSwap { get; init; } = IntelText.LootScanVerdictSwap;
    public string VerdictLeave { get; init; } = IntelText.LootScanVerdictLeave;
    public string VerdictReview { get; init; } = IntelText.LootScanVerdictReview;

    /// <summary>The chip word for a settled verdict; a pending or advised take has its own.</summary>
    public string Verdict(LootScanVerdict verdict) => verdict switch
    {
        LootScanVerdict.Take => VerdictTake,
        LootScanVerdict.Swap => VerdictSwap,
        LootScanVerdict.Leave => VerdictLeave,
        LootScanVerdict.Review => VerdictReview,
        _ => verdict.ToString().ToUpperInvariant(),
    };

    // A fresh record per read, not one cached instance: the defaults come from the string table,
    // and a cached copy would keep whichever culture was current the first time it was touched.
    public static LootScanPresentationText Default => new();
}
