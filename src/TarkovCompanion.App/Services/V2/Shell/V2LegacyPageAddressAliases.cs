...
/// matches segments case-insensitively. Five do not, for the same reason: the route each named
...
/// (package 3, #291); "Squad" and "Group" now both host the Team workspace (package 9, #289).
