...
/// matches segments case-insensitively. Two do not, for the same reason: the route each named
...
/// "Raid" now hosts the raid cockpit (package 2, #286). The overrides below are those two
/// historical mappings, not a general escape hatch — a route that never had a v1 page has
/// nothing to alias, and gets none.
/// </remarks>
