...
A counted participant is a **real person who plays Escape from Tarkov** and is a plausible internal
user of the companion. The five-person minimum in #265 counts only such people. These do **not**
...
| **Accessibility-relevant**: uses a screen reader, screen magnification, 200% or larger text, keyboard-only or switch access, voice control, Windows high contrast or a contrast theme, reduced motion by need, or has a colour-vision deficiency or a motor difference that affects touch or mouse use | 1 | Screener Q9, self-described and optional |
| Screen-reader user (subset of the row above) | 1 **if recruitable** | Screener Q9. If none can be recruited, the report records the gap; see research-plan.md section 8 |
| Squad player who shares a plan or marks with others | 2 | Screener Q5 |
...
4. Which of these do you actively think about in a raid? *(choose any: loot value per square ·
   quest items · hideout items · routes and extracts · none of these)*
5. How do you usually play? *(mostly solo · mostly with a regular squad · both)*
...
- **Expert:** Q1 at least "1 to 3 years", Q2 "2 to 3" or more, and Q4 includes loot value per
  square or quest items.
- **Regular or returning:** Q3 "most days", "most weeks" or "returning after a break", and not
  already the only expert.
