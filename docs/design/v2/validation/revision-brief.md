...
| RB-04 | **Global Capture** | Capture in the header of every desktop page and on the tablet: what is armed, its revision and device, "N captures need a decision" with Decide, recent captures. Loot Scan's "Scan again" replaced by "Waiting for your next screenshot" or "Analyse this screenshot again" | RA-X4, RA-L7 |
...
| --- | --- | --- | --- |
| RB-05 | All desktop, Home, Stash | Remove the global "Ready" pill. Replace with a counted status that links to its detail; during a scan show the scan's state, not "Ready" | RA-X5, RA-H1 |
...
| RB-16 | Team tablet, tablet control | The paired tablet is always "your device, not a squad member"; its permissions match its role everywhere (an observer cannot invite or manage access); one role for the same device across renders | RA-T1, RA-T2, RA-C4 |
