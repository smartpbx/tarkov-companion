...
window.STORYBOARD_CONTENT = {
  ...
  // Every participant-facing non-route link generated by storyboard.js comes from this manifest.
  // link-audit.mjs loads this file without a browser and verifies each target inside the canonical
  // docs/ distribution bundle; hash routes remain same-document links.
  distributionLinks: {
    safety: '../../../../SAFETY.md',
    dataMethodology: '../../../../DATA_SOURCES.md'
  },
  localTime: '18:42',
  ...
  captureStages: ['Arrival admitted', 'Source settled', 'Duplicate checked', 'Decoded', 'Context',
    'Grid and regions', 'Item matches', 'Profile lookup', 'Recommendation', 'Complete'],
  ...
  loot: {
    ...
    // Each offered correction is a complete recomputation, not a label pasted over the REVIEW row.
    // This list is also a ratchet: adding an option requires its identity/count/decision/reasons,
    // change copy, dimensions, values and details destination to be stated here.
    correctionChoices: [
      { id: 'military-cable', label: 'Military cable', item: 'military-cable', countsAsItem: true,
        decision: 'LEAVE', reasons: ['Identity manually confirmed', 'Below your value band', 'No quest, hideout or pin needs it'],
        change: 'Would become TAKE if you pin it or a quest or hideout need is added.' },
      { id: 'power-cord', label: 'Power cord', item: 'power-cord', countsAsItem: true,
        decision: 'LEAVE', reasons: ['Identity manually corrected', 'Below your value band', 'No quest, hideout or pin needs it'],
        change: 'Would become TAKE if you pin it or a quest or hideout need is added.' },
      { id: 'not-an-item', label: 'Not an item', item: null, countsAsItem: false,
        decision: 'EXCLUDED', reasons: ['Region manually marked as not an item', 'Excluded from item, space and value totals'],
        change: 'Undo restores the original uncertain Military cable result.',
        size: 'Not applicable', value: 'Not applicable', perSquare: 'Not applicable',
        details: 'No item details: this region was excluded as not an item.' }
    ]
  },
