...
| M-05 | Keep all raw session material, individual probe answers and participant-level paraphrases outside this public repository. Commit only aggregate coverage and de-identified aggregate paraphrase, except an exact quote that separately completes approval, a seven-day embargo and a final revocation check. | The repository and release feed are public (#256 review snapshot). De-identification alone does not make a small internal participant's answer safe to publish. | Proposed |
