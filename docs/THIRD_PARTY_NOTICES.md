...
- Michael P. Starkweather and SPT-DynamicMaps contributors provide the pinned static marker-coordinate reference for nine reviewed extract facts under the plugin's MIT terms; see [commit `4944764f5f6c42d152dca6bd1b5371c4f6212a9e`](https://github.com/acidphantasm/SPT-DynamicMaps/tree/4944764f5f6c42d152dca6bd1b5371c4f6212a9e/Plugin/Resources/Maps). The retained upstream credit names TarkovTracker/tarkovData, TarkovDev, and Shebuka as additional map-data sources. No source code, SVG or other map layer, artwork, icon, or marker asset is included. See `LICENSES/SPT-DynamicMaps-MIT.txt` and `LICENSES/SPT-DynamicMaps-map-and-data-credits.txt`.
