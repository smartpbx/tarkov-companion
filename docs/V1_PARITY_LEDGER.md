...
| --- | --- | --- | --- | --- |
| Raid | `#/raid` — `RaidCockpitView`: the V2 map renderer, raid timer, extracts, marks, objectives | Replaced | #286 | `RaidCockpitExtractRowsTests`, `RaidCockpitObjectivesTests`, `RaidCockpitLiveLayersTests`, `RaidCockpitMarksLayerTests`, `RaidCockpitArtworkAndFloorsTests`, `RaidMapSpaceTests`, `RaidMarkGestureTests`; gallery `v2-a-raid-1920`/`-3840`, which also holds the map card to at least 0.66 x 0.75 of the window |
