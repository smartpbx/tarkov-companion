...
// were never answered. Run with `node scripts/test-command-acknowledgement.mjs`; the unit-test suite
// runs it too (CommandAcknowledgementScriptTests), so a change here that breaks it fails CI.
