...
# host; GitHub Actions runs it with TARKOV_RELEASE_REQUIRE_TOOLS=1 so a missing pwsh or shell
# linter fails there instead of quietly skipping what they check.
