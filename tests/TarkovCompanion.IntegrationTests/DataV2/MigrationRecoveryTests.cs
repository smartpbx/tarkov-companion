...
public sealed class MigrationRecoveryTests
{
    ...
    public async Task LedgerHasPairedUpgradeAndRollbackFixturesAndFreshDatabaseAppliesAll()
    {
        ...
        Assert.Equal(15, SqliteMigrationLedger.Entries.Count);
        ...
        Assert.Equal(15, await V2TestDatabase.ScalarAsync(database.Factory, "SELECT COUNT(*) FROM schema_migrations;"));
