...
state = {"authorityEpoch": EPOCH, "workspaceId": WORKSPACE, "desktopInstanceId": DESKTOP_INSTANCE, "globalRevision": rev(7), "desktopDeviceId": DESKTOP, "deviceModes": device_modes, "workspace": workspace, "marks": marks, "captureIntent": capture}
